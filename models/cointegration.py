...
Tests if Gold and Silver prices are cointegrated for pair trading
...
class CointegrationTest:
    ...
    Example:
        ...
        >>> result = tester.test_engle_granger(gold_prices, silver_prices)
    ...
    def test_engle_granger(self,
        ...
        Args:
            series1: First price series (e.g., Gold)
            series2: Second price series (e.g., Silver)
...
def quick_test(gold_prices: pd.Series,
              silver_prices: pd.Series) -> CointegrationResult:
    """
    ...
    Example:
        >>> result = quick_test(gold_df['close'], silver_df['close'])
        >>> print(result)
    """
    tester = CointegrationTest()
    return tester.test_engle_granger(gold_prices, silver_prices)
