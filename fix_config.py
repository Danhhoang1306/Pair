"""
EMERGENCY FIX - Run this to fix config import issue
"""
...
print("="*70)
print("EMERGENCY FIX FOR CONFIG IMPORT")
print("="*70)

# Backup old file
if config_init.exists():
    backup = config_dir / '__init__.py.backup'
    print(f"📦 Backing up old file to {backup}")
    import shutil
    shutil.copy(config_init, backup)

# Write new config/__init__.py
new_content = '''"""
...
print(f"✍️ Writing new config/__init__.py")
with open(config_init, 'w', encoding='utf-8') as f:
    f.write(new_content)

print(f"✅ Config file updated!")
print(f"")
print(f"Now try again:")
print(f"  python launch_gui.py")
print(f"")
print(f"="*70)
