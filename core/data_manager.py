...
class DataManager:
    ...
    def get_pair_data(self,
        ...
        """
        Get synchronized pair data (Primary & Silver)
        ...
        # Add metadata
        primary_df = self._add_metadata(primary_df, self.gold_symbol, timeframe)
        secondary_df = self._add_metadata(secondary_df, self.silver_symbol, timeframe)
    ...
    def get_single_data(self,
        ...
        Args:
            symbol: Symbol name (default: gold_symbol)
            timeframe: Timeframe
            days: Number of days
    ...
    def print_data_summary(self,
        ...
        print(f"\n[UP] Data Quality:")
        print(f"  Missing values (Gold):   {quality['primary_missing']}")
        print(f"  Missing values (Silver): {quality['secondary_missing']}")
    ...
    def _validate_pair_data(self,
        ...
        if len(primary_df) != len(secondary_df):
            logger.warning(f"Length mismatch: Gold={len(primary_df)}, Silver={len(secondary_df)}")
    ...
    def __repr__(self):
        ...
        return f"DataManager(status={status}, symbols={self.gold_symbol}/{self.silver_symbol})"
