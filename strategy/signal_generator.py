...
Strategy:
- LONG SPREAD when z-score < -2.0 (Gold undervalued)
- SHORT SPREAD when z-score > +2.0 (Gold overvalued)
...
class SignalType(Enum):
    """Signal type"""
    LONG_SPREAD = "LONG_SPREAD"      # Buy Gold, Sell Silver
    SHORT_SPREAD = "SHORT_SPREAD"    # Sell Gold, Buy Silver
